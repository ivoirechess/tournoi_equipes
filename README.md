...
## Refactor multi-format (2026)
- Le frontend est désormais orienté *tournoi sélectionné* (pas uniquement team cup).
- Ajout d'une séparation explicite entre base joueurs globale et `tournament_registrations`.
- Nouveau workflow admin d'import Chess.com piloté par le calendrier (tournoi -> round -> fixture -> candidats -> confirmation).
- Migration SQL proposée: `011_multi_format_platform_core.sql`.
- Détails d'audit + architecture dans `docs/multi_format_refactor.md`.
